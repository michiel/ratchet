...
fn test_simplified_list_query_serde() {
    ...
    let parsed: ListQuery =
        serde_urlencoded::from_str(query_string).expect("Should deserialize Refine.dev style parameters");
    ...
    let parsed: ListQuery =
        serde_urlencoded::from_str(query_string).expect("Should deserialize standard pagination parameters");
    ...
    let parsed: ListQuery = serde_urlencoded::from_str(query_string).expect("Should deserialize mixed parameters");
