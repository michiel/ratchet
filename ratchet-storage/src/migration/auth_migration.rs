        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(ApiKeys::Permissions).string().not_null().default("read"))
                    ...
                    .col(ColumnDef::new(ApiKeys::UsageCount).big_integer().not_null().default(0))
                    .foreign_key(
                        ForeignKey::create()
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Sessions::SessionId).string().not_null().unique_key())
