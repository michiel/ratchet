...
mod tests {
    ...
    async fn test_database_seeding() {
        ...
        let tasks = vec![
            crate::seaorm::entities::tasks::Model {
                ...
                source_code: "console.log('Hello from task1');".to_string(),
                source_type: "javascript".to_string(),
                storage_type: "database".to_string(),
                file_path: Some("test/path1/task.js".to_string()),
                checksum: "abc123".to_string(),
                repository_id: 1,
                repository_path: "test/path1".to_string(),
                last_synced_at: None,
            ...
            crate::seaorm::entities::tasks::Model {
                ...
                version: "1.0.0".to_string(),
                path: Some("test/path2".to_string()),
                metadata: serde_json::json!({}),
                input_schema: serde_json::json!({}),
                output_schema: serde_json::json!({}),
                enabled: true,
                // New required fields for full task storage
                source_code: "console.log('Hello from task2');".to_string(),
                source_type: "javascript".to_string(),
                storage_type: "database".to_string(),
                file_path: Some("test/path2/task.js".to_string()),
                checksum: "def456".to_string(),
                repository_id: 1,
                repository_path: "test/path2".to_string(),
                last_synced_at: None,
                sync_status: "synced".to_string(),
                is_editable: true,
                created_from: "test".to_string(),
    ...
    async fn test_database_clearing() {
        ...
        let tasks = vec![crate::seaorm::entities::tasks::Model {
            ...
            enabled: true,
            // New required fields for full task storage
            source_code: "console.log('Hello from test');".to_string(),
            source_type: "javascript".to_string(),
            storage_type: "database".to_string(),
            file_path: Some("test/path/task.js".to_string()),
            checksum: "test123".to_string(),
            repository_id: 1,
            repository_path: "test/path".to_string(),
            last_synced_at: None,
            sync_status: "synced".to_string(),
            is_editable: true,
            created_from: "test".to_string(),
    ...
    async fn test_macro_usage() {
        ...
        let tasks = vec![crate::seaorm::entities::tasks::Model {
            ...
            version: "1.0.0".to_string(),
            path: Some("test/macro".to_string()),
            metadata: serde_json::json!({}),
            input_schema: serde_json::json!({}),
            output_schema: serde_json::json!({}),
            enabled: true,
            // New required fields for full task storage
            source_code: "console.log('Hello from macro-test');".to_string(),
            source_type: "javascript".to_string(),
            storage_type: "database".to_string(),
            file_path: Some("test/macro/task.js".to_string()),
            checksum: "macro123".to_string(),
            repository_id: 1,
            repository_path: "test/macro".to_string(),
            last_synced_at: None,
            sync_status: "synced".to_string(),
            is_editable: true,
            created_from: "test".to_string(),
    ...
    async fn test_seeded_macro_usage() {
        ...
        let tasks = vec![
            crate::seaorm::entities::tasks::Model {
                ...
                version: "1.0.0".to_string(),
                path: Some("test/seeded1".to_string()),
                metadata: serde_json::json!({}),
                input_schema: serde_json::json!({}),
                output_schema: serde_json::json!({}),
                enabled: true,
                // New required fields for full task storage
                source_code: "console.log('Hello from seeded1');".to_string(),
                source_type: "javascript".to_string(),
                storage_type: "database".to_string(),
                file_path: Some("test/seeded1/task.js".to_string()),
                checksum: "abc123".to_string(),
                repository_id: 1,
                repository_path: "test/seeded1".to_string(),
                last_synced_at: None,
                sync_status: "synced".to_string(),
                is_editable: true,
                created_from: "test".to_string(),
            ...
            crate::seaorm::entities::tasks::Model {
                ...
                version: "1.0.0".to_string(),
                path: Some("test/seeded2".to_string()),
                metadata: serde_json::json!({}),
                input_schema: serde_json::json!({}),
                output_schema: serde_json::json!({}),
                enabled: true,
                // New required fields for full task storage
                source_code: "console.log('Hello from seeded2');".to_string(),
                source_type: "javascript".to_string(),
                storage_type: "database".to_string(),
                file_path: Some("test/seeded2/task.js".to_string()),
                checksum: "def456".to_string(),
                repository_id: 1,
                repository_path: "test/seeded2".to_string(),
                last_synced_at: None,
                sync_status: "synced".to_string(),
                is_editable: true,
                created_from: "test".to_string(),
