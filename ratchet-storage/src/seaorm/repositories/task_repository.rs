...
mod tests {
    ...
    fn create_sample_task() -> Task {
        Task {
            ...
            source_code: "console.log('Hello from test-task');".to_string(),
            source_type: "javascript".to_string(),
            storage_type: "database".to_string(),
            file_path: Some("/path/to/task/task.js".to_string()),
            checksum: "sample123".to_string(),
            repository_id: 1,
            repository_path: "/path/to/task".to_string(),
            last_synced_at: None,
