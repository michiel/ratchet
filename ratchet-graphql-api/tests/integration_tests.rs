...
use ratchet_graphql_api::{
    ...
    schema::{configure_schema, create_schema, RatchetSchema},
};
use ratchet_interfaces::{
    ApiKeyRepository, RegistryManager, RepositoryFactory, SessionRepository, TaskRegistry, TaskValidator,
    UserRepository,
};
use serde_json::json;
use std::sync::Arc;
...
impl GraphQLTestServer {
    ...
    pub async fn with_config(config: GraphQLTestConfig) -> Self {
        ...
        let context = GraphQLContext::new(repositories, registry, registry_manager, validator);
    ...
    async fn execute_request(&self, request: Request) -> Response {
        self.schema.execute(request.data(self.context.clone())).await
    }
}
...
mod mocks {
    ...
    use ratchet_api_types::{pagination::PaginationMeta, ListResponse, PaginationInput};
    use ratchet_interfaces::{
        DatabaseError, ExecutionFilters, JobFilters, RegistryError, ScheduleFilters, SyncResult, TaskFilters,
        TaskMetadata, ValidationResult,
    };
    ...
    impl ratchet_interfaces::JobRepository for MockJobRepository {
        ...
        async fn schedule_retry(&self, _id: ApiId, _retry_at: chrono::DateTime<Utc>) -> Result<(), DatabaseError> {
            Ok(())
        }
    ...
    impl ratchet_interfaces::ScheduleRepository for MockScheduleRepository {
        ...
        async fn update_next_run(&self, _id: ApiId, _next_run: chrono::DateTime<Utc>) -> Result<(), DatabaseError> {
            Ok(())
        }
        async fn set_enabled(&self, _id: ApiId, _enabled: bool) -> Result<(), DatabaseError> {
            Ok(())
    ...
    impl ratchet_interfaces::CrudRepository<ratchet_api_types::UnifiedUser> for MockUserRepository {
        async fn create(
            &self,
            entity: ratchet_api_types::UnifiedUser,
        ) -> Result<ratchet_api_types::UnifiedUser, DatabaseError> {
            Ok(entity)
        }
        async fn find_by_id(&self, _id: i32) -> Result<Option<ratchet_api_types::UnifiedUser>, DatabaseError> {
            Ok(Some(create_test_user()))
        }
        async fn find_by_uuid(&self, _uuid: Uuid) -> Result<Option<ratchet_api_types::UnifiedUser>, DatabaseError> {
            Ok(Some(create_test_user()))
        }
        async fn update(
            &self,
    ...
    #[async_trait]
    impl ratchet_interfaces::FilteredRepository<ratchet_api_types::UnifiedUser, ratchet_interfaces::UserFilters>
        for MockUserRepository
    {
        async fn find_with_filters(
            &self,
            _filters: ratchet_interfaces::UserFilters,
            pagination: PaginationInput,
        ) -> Result<ListResponse<ratchet_api_types::UnifiedUser>, DatabaseError> {
        ...
        async fn find_with_list_input(
            &self,
            filters: ratchet_interfaces::UserFilters,
            list_input: ratchet_api_types::pagination::ListInput,
        ) -> Result<ListResponse<ratchet_api_types::UnifiedUser>, DatabaseError> {
            self.find_with_filters(filters, list_input.get_pagination()).await
        }
        async fn count_with_filters(&self, _filters: ratchet_interfaces::UserFilters) -> Result<u64, DatabaseError> {
            Ok(1)
        }
    }
    #[async_trait]
    impl UserRepository for MockUserRepository {
        async fn find_by_username(
            &self,
            _username: &str,
        ) -> Result<Option<ratchet_api_types::UnifiedUser>, DatabaseError> {
            Ok(None)
        }
        async fn find_by_email(&self, _email: &str) -> Result<Option<ratchet_api_types::UnifiedUser>, DatabaseError> {
            Ok(None)
        }
        ...
        async fn update_password(&self, _id: ApiId, _password_hash: &str) -> Result<(), DatabaseError> {
            Ok(())
        }
        async fn update_last_login(&self, _id: ApiId) -> Result<(), DatabaseError> {
            Ok(())
        }
        async fn set_active(&self, _id: ApiId, _active: bool) -> Result<(), DatabaseError> {
            Ok(())
        }
        async fn verify_email(&self, _id: ApiId) -> Result<(), DatabaseError> {
            Ok(())
        }
    }
    ...
    impl ratchet_interfaces::CrudRepository<ratchet_api_types::UnifiedSession> for MockSessionRepository {
        async fn create(
            &self,
            entity: ratchet_api_types::UnifiedSession,
        ) -> Result<ratchet_api_types::UnifiedSession, DatabaseError> {
            Ok(entity)
        }
        async fn find_by_id(&self, _id: i32) -> Result<Option<ratchet_api_types::UnifiedSession>, DatabaseError> {
            Ok(Some(create_test_session()))
        }
        async fn find_by_uuid(&self, _uuid: Uuid) -> Result<Option<ratchet_api_types::UnifiedSession>, DatabaseError> {
            Ok(Some(create_test_session()))
        }
        async fn update(
            &self,
    ...
    impl SessionRepository for MockSessionRepository {
        ...
        async fn find_by_session_id(
            &self,
            _session_id: &str,
        ) -> Result<Option<ratchet_api_types::UnifiedSession>, DatabaseError> {
            Ok(None)
        }
        async fn find_by_user_id(
            &self,
            _user_id: ApiId,
        ) -> Result<Vec<ratchet_api_types::UnifiedSession>, DatabaseError> {
            Ok(vec![])
        }
        async fn invalidate_session(&self, _session_id: &str) -> Result<(), DatabaseError> {
            Ok(())
        }
        async fn invalidate_user_sessions(&self, _user_id: ApiId) -> Result<(), DatabaseError> {
            Ok(())
        }
        async fn update_last_used(&self, _session_id: &str) -> Result<(), DatabaseError> {
            Ok(())
        }
    ...
    impl ratchet_interfaces::CrudRepository<ratchet_api_types::UnifiedApiKey> for MockApiKeyRepository {
        async fn create(
            &self,
            entity: ratchet_api_types::UnifiedApiKey,
        ) -> Result<ratchet_api_types::UnifiedApiKey, DatabaseError> {
            Ok(entity)
        }
        async fn find_by_id(&self, _id: i32) -> Result<Option<ratchet_api_types::UnifiedApiKey>, DatabaseError> {
            Ok(Some(create_test_api_key()))
        }
        async fn find_by_uuid(&self, _uuid: Uuid) -> Result<Option<ratchet_api_types::UnifiedApiKey>, DatabaseError> {
            Ok(Some(create_test_api_key()))
        }
        async fn update(
            &self,
    ...
    impl ApiKeyRepository for MockApiKeyRepository {
        async fn find_by_key_hash(
            &self,
            _key_hash: &str,
        ) -> Result<Option<ratchet_api_types::UnifiedApiKey>, DatabaseError> {
            Ok(None)
        }
        async fn find_by_user_id(
            &self,
            _user_id: ApiId,
        ) -> Result<Vec<ratchet_api_types::UnifiedApiKey>, DatabaseError> {
            Ok(vec![])
        }
        ...
        async fn update_last_used(&self, _id: ApiId) -> Result<(), DatabaseError> {
            Ok(())
        }
        async fn increment_usage(&self, _id: ApiId) -> Result<(), DatabaseError> {
            Ok(())
        }
        async fn set_active(&self, _id: ApiId, _active: bool) -> Result<(), DatabaseError> {
            Ok(())
