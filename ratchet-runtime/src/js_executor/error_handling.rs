//! JavaScript error handling for runtime execution

use crate::error::{JsErrorType, JsExecutionError};
...
/// Register custom error types in the JavaScript context (no-op without javascript feature)
#[cfg(not(feature = "javascript"))]
pub fn register_error_types(_context: &mut ()) -> Result<(), JsExecutionError> {
