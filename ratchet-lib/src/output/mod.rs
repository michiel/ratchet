//! Output destination system for delivering task results
//! 
//! This module provides a flexible system for delivering task outputs to various
...
pub use destination::{OutputDestination, TaskOutput, DeliveryContext, DeliveryResult};
pub use destinations::{FilesystemDestination, WebhookDestination};
pub use manager::OutputDeliveryManager;
pub use template::TemplateEngine;
pub use errors::{DeliveryError, ConfigError, ValidationError};
...
fn default_post_method() -> HttpMethod { HttpMethod::Post }
fn default_webhook_timeout() -> Duration { Duration::from_secs(30) }
fn default_max_attempts() -> u32 { 3 }
fn default_initial_delay() -> Duration { Duration::from_secs(1) }
fn default_max_delay() -> Duration { Duration::from_secs(60) }
fn default_backoff_multiplier() -> f64 { 2.0 }
fn default_retry_status_codes() -> Vec<u16> { vec![429, 500, 502, 503, 504] }
