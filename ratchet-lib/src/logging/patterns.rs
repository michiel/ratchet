...
impl MatchingRule {
    ...
    pub fn matches(&self, error: &ErrorInfo) -> bool {
        match self {
            ...
            Self::MessagePattern { pattern } => match Regex::new(pattern) {
...
impl ErrorPatternMatcher {
    ...
    pub fn match_all(&self, error: &ErrorInfo) -> Vec<&ErrorPattern> {
        self.patterns.iter().filter(|p| p.matches(error)).collect()
    }
    ...
    fn default_patterns() -> Vec<ErrorPattern> {
        vec![
            ...
            ErrorPattern {
                ...
                related_documentation: vec!["https://docs.ratchet.io/task-management".to_string()],
                common_causes: vec![
            ...
            ErrorPattern {
                ...
                matching_rules: vec![MatchingRule::Any {
                    rules: vec![
                        MatchingRule::ErrorCode {
                            value: "NETWORK_TIMEOUT".to_string(),
                        },
                        MatchingRule::All {
                            rules: vec![
            ...
            ErrorPattern {
                ...
                related_documentation: vec!["https://docs.ratchet.io/rate-limiting".to_string()],
                common_causes: vec![
