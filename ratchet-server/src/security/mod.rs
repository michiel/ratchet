...
mod tests {
    ...
    fn test_security_context_creation() {
        let context = SecurityContext::new("test-correlation-id".to_string());
    ...
    fn test_security_context_system() {
        ...
        assert_eq!(context.user_id, Some("system".to_string()));
    ...
    fn test_security_context_roles() {
        let mut context = SecurityContext::new("test".to_string());
    ...
    fn test_security_event_creation() {
        let context = SecurityContext::new("test".to_string());
        let event = SecurityEvent::new(
            SecurityEventType::Authentication,
            SecurityEventSeverity::Info,
