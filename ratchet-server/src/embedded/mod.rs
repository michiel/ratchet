...
mod tests {
    ...
    fn test_heartbeat_metadata_is_valid_json() {
        ...
        serde_json::from_str::<serde_json::Value>(metadata).expect("Heartbeat metadata should be valid JSON");
    }
    ...
    fn test_heartbeat_schemas_are_valid_json() {
        ...
        serde_json::from_str::<serde_json::Value>(input_schema).expect("Heartbeat input schema should be valid JSON");
        serde_json::from_str::<serde_json::Value>(output_schema).expect("Heartbeat output schema should be valid JSON");
    }
}
